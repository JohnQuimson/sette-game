...
const allSet = computed(() => {
   ...
   return game.players.every((p) => p?.resultCorrect !== null && p?.resultCorrect !== undefined);
});
...
<template>
   <div class="p-5 position-relative">
      ...
      <div class="row d-flex justify-content-between">
         ...
         <div class="col-12 col-md-3 border border-secondary-subtle py-3 px-3 bg-light rounded mt-3 mt-md-0">
            ...
            <ul class="list-group mb-3">
               ...
               >
                  <div>
                     ...
                     <small class="text-muted d-block">Dichiarate: {{ player?.declared }}</small>
                  </div>
                  <span :class="player?.resultCorrect ? 'badge bg-success' : 'badge bg-danger'">
            ...
            <div
               ...
               :class="totalTaken === game.currentCards ? 'alert-success' : 'alert-danger'"
            >
               Totale prese: <strong>{{ totalTaken }}</strong> / {{ game.currentCards }}
            </div>

            <div class="d-flex gap-2">
               <button class="btn btn-outline-secondary w-50" @click="showModal = true">✏️ Modifica</button>
               <button
      ...
      <div v-if="showModal && currentPlayer" class="modal-backdrop fade show"></div>
      <div v-if="showModal && currentPlayer" class="modal d-block tab-index--1" role="dialog" style="top: 15%">
            ...
            <div class="modal-content shadow-lg border-success">
               ...
               <div class="modal-content py-4 px-4 text-center">
                  ...
                  <p class="fs-5 text-muted">
                     Ha dichiarato: <strong class="text-primary">{{ currentPlayer?.declared }}</strong>
                  </p>
                  ...
                  <div v-else-if="currentPlayer?.resultCorrect === false" class="my-4 mx-auto" style="max-width: 200px">
                     ...
                     <input
                        ...
                        v-model.number="currentPlayer.taken"
                     />
                     <button
                  ...
                  <div class="d-flex justify-content-between border-top pt-3 mt-3">
                     ...
                     <button
                        ...
                        :disabled="
                           ...
                           (currentPlayer?.resultCorrect === false && currentPlayer?.taken === currentPlayer?.declared)
                        "
                        @click="nextStep"
                     >
                  ...
                  <div class="border-top pt-3 mt-3">
                     <button class="btn btn-outline-danger btn-sm w-100" @click="router.push('/declarations')">
