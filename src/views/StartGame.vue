...
<template>
   <div class="container py-5 text-center">
      ...
      <input type="number" class="form-control w-25 mx-auto mb-3 text-center" min="4" max="7" v-model="playersCount" />

      <button class="btn btn-lg btn-primary" @click="start">Gioca</button>
